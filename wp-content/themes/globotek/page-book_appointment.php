			...
			<form class="form" method="post" data-module="form-page">
				...
				<div class="form-page js-page__target">
					...
					<div class="form__page" data-id="1" style="display: block;">
						...
						<p class="heading heading__secondary form__page__heading">Please select a date</p>
						...
						<p class="heading heading__secondary form__page__heading">Please select a timeslot</p>
...
<!--							--><?php //} ?>
					...
					<div class="form__page" data-id="2">
						...
						<p class="heading heading__secondary form__page__heading">Details</p>
					...
					<div class="form__page" data-id="3">
						...
						<p class="heading heading__secondary form__page__heading">Confirm</p>
...
>>>>>>> b276d8f1b1af88597d613ca593d121f2766dc53b
