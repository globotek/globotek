...
function icon( $svg_title, $css_class = NULL, $type = 'static' ) {
	...
	if ( $type == 'static' ) {
		...
		echo '<svg class="icon ' . $css_class . '" aria-hidden="true" aria-labelledby="title">';
		...
		echo '<img src="' . get_template_directory_uri() . '/images/svg/' . $svg_title . '.svg" alt="' . ucwords( str_replace( '-', ' ', $svg_title ) ) . '">';
