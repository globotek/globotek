...
<div class="testimonial">
	...
	<img src="<?php echo get_stylesheet_directory_uri() . '/images/quote-left.png'; ?>" alt="" class="testimonial__decor--left">
	...
	<img src="<?php echo get_stylesheet_directory_uri() . '/images/quote-right.png'; ?>" alt="" class="testimonial__decor--right">
